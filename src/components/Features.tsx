      ...
      <div className="section-container">
        <div className="text-center mb-10 sm:mb-16">
          ...
          <h2 className="section-title mb-3 sm:mb-4 opacity-0 fade-in-element">
            Інтелектуальний асистент для незалежності
          </h2>
          <p className="section-subtitle mx-auto opacity-0 fade-in-element">
            Повертаємо людям самостійність, прибираємо інформаційну ізоляцію та робимо життя доступнішим.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
          <FeatureCard
            ...
            title="Адаптивність"
            description="Асистент навчається на ваших діях, постійно вдосконалюючи підтримку."
            index={0}
          />
          <FeatureCard
            ...
            title="Природна взаємодія"
            description="Голосове керування, зрозумілий інтерфейс, адаптація під користувача."
            index={1}
          />
          <FeatureCard
            ...
            title="Точність"
            description="Використання сучасних технологій для максимальної точності розпізнавання."
            index={2}
          />
          <FeatureCard
            ...
            title="Безпека"
            description="Захист даних, безпечна робота, підтримка у складних ситуаціях."
            index={3}
          />
          <FeatureCard
            ...
            title="Доступність"
            description="Додаток адаптований під українські реалії, простий у використанні."
            index={4}
          />
          <FeatureCard
            ...
            title="Підтримка"
            description="Постійне оновлення, нові функції, підтримка користувачів."
            index={5}
          />
        </div>
      </div>
